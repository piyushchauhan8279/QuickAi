  ...
  return (
    ...
    >
      ...
      >
        ...
        <button disabled={loading} className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] px-4 py-2 mt-6 text-sm rounded-b-lg cursor-pointer text-white ">
          {
