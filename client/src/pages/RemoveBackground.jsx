  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] px-4 py-2 mt-6 text-sm rounded-b-lg cursor-pointer text-white "
        >
          {loading ? (
        ...
        {!content ? (
          <div className="flex flex-1 justify-center items-center">
            <div className="text-sm flex flex-col gap-5 items-center text-gray-400 ">
              ...
              <p>Upload an image and click "Remove Backgroud" to get started</p>
            </div>
          </div>
        ) : (
