  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <h1
          className="text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl mx-auto
      ...
      {/* <div className="flex gap-4 items-center mt-8 mx-auto text-gray-800">
        <img src={assets.user_group} alt="image" className="h-8" />
