...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  max-sm:fixed max-sm:top-14 max-sm:left-0 max-sm:bottom-0 
  ...
  transition-all duration-300 ease-in-out z-50`}
    >
      <div className="my-7 w-full">
        ...
        <div className="mt-5 px-6 font-medium text-sm text-gray-600">
      ...
      <div className="w-full border-t border-gray-200 p-4 px-7 flex justify-between items-center">
        <div
